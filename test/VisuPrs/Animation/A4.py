...
#This case corresponds to: /visu/animation/A4 case
#%Create animation for Cut Lines  for 'pression' field of the the given MED file and dumps picture files in JPEG format %
