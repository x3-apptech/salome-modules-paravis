...
#This case corresponds to: /visu/animation/G4case
#%Create animation for Stream Lines for 'vitesse' field of the the given MED file and dumps picture files in TIFF format %
