...
#This case corresponds to: /visu/animation/C8 case
#%Create animation for Gauss Points for 'pression' field of the the given MED file and dumps picture files in JPEG format %
