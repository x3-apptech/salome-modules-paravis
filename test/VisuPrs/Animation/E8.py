...
# This case corresponds to: /visu/animation/E8 case
# Create animation for Plot 3D for 'pression' field of the the given MED file and dumps picture files in TIFF format %
