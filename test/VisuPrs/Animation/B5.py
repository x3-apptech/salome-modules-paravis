...
#This case corresponds to: /visu/animation/B5 case
#%Create animation for Cut Planes for 'pression' field of the the given MED file and dumps picture files in PNG format %
