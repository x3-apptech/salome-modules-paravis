...
#This case corresponds to: /visu/animation/E0 case
#%Create animation for Iso Surfaces  for 'pression' field of the the given MED file and dumps picture files in TIFF format %
