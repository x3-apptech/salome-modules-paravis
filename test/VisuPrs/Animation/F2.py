...
#This case corresponds to: /visu/animation/F2 case
#%Create animation for Scalar Map on Deformed Shape for 'vitesse' field of the the given MED file and dumps picture files in JPEG format %
