...
#This case corresponds to: /visu/animation/A2 case
#%Create animation for Scalar Map for 'pression' field of the the given MED file and dumps picture files in TIFF format %
